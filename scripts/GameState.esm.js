...
export class GameState {
   constructor(level, leftMovement, pointsToWin, diamonds, diamondsSpriteImage) {
      let _leftMevement = leftMovement;
      let _playerScores = 0;
      ...
      this.getLeftMovement = () => _leftMevement;
      this.decreasePoitsMovement = () => _leftMevement--;
      this.increasePoitsMovement = () => _leftMevement++;
   ...
   mixDiamonds() {
      const mixedDiamonds = _gameBoard(0, DIAMONDS_ARRAY_WIDTH);
